...
public:
    ...
    {
        // 310P: fp16 only (4 combos). 910B/910C: bf16+fp16 (8 combos, appended after).
        // Combo layout: [input_type, g_type, state_type]
        // 0: fp16, fp32, fp16   1: fp16, fp32, fp32   2: fp16, fp16, fp16   3: fp16, fp16, fp32
        this->Input("k")
            .ParamType(REQUIRED)
