...
## 2026-08-31 13:45: micro-mm state
- mm1 (T-updates): GREEN 1370. mm2/mm3 (12/14 calls): W micro PERFECT on quiet shapes (w=1.0 on 1,512,4,4),
  canonical W partial (storeBuf W-store hazard, mm4 fix in flight), U total garbage (-0.005) DETERMINISTIC on all shapes
  even with direct uncompacted B. Speed at 12/14: 1115us.
- U bug candidates exhausted statically; empirical bisect next (revert U to lib, isolate).
- Micro-mm learnings: cross-call needs MTE1_MTE3 + M_MTE1 guards; storeBuf reuse needs MTE3_V.
